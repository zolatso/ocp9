...
from .views import ReviewCreateView, ReviewDeleteView, ReviewUpdateView, home, my_posts, ticket_review_create
...
urlpatterns = [
    ...
    path('abonnements/remove_follower/<int:id>', remove_follower, name='remove-follower'),
